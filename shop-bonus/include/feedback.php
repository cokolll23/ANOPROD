...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/shop-bonus/about/idea/",
            "PATH_IDEA_POST" => "/shop-bonus/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/shop-bonus/login/?forgot_password=yes",
            "REGISTER_URL" => "/shop-bonus/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
