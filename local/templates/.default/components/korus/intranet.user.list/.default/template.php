...
<div class="[ phonebook-header-wrapper ]">
    <header class="[ phonebook-header ]">
        <?php $APPLICATION->IncludeComponent("korus:phonedirectory.favourites", "", []); ?>
        <?php $APPLICATION->IncludeComponent("korus:phonedirectory.historysearched", "", []); ?>
    </header>
</div>
