...
if (is_array($arInfo) && $arInfo["ELEMENT_ID"]):?>
    ...
    $APPLICATION->IncludeComponent("bitrix:bizproc.document", "webdav.bizproc.document", array(
        ...
        "WORKFLOW_LOG_URL" => str_replace("#ELEMENT_ID#", "#DOCUMENT_ID#",
            $arResult["~PATH_TO_USER_FILES_WEBDAV_BIZPROC_LOG"]),
        "WORKFLOW_START_URL" => str_replace("#ELEMENT_ID#", "#DOCUMENT_ID#",
            $arResult["~PATH_TO_USER_FILES_WEBDAV_START_BIZPROC"]),
