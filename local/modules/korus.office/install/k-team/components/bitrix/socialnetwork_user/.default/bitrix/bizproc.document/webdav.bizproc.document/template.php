...
<div class="bizproc-page-document">
    ...
    <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" class="bizproc-form" name="start_workflow_form1"
          id="start_workflow_form1">
        <?= bitrix_sessid_post() ?>
        <?
                    ...
                    <table class="bizproc-table-main" cellpadding="0" border="0">
                        ...
                        if (count($arEvents) > 0) {
                            ...
                            <tr class="<?= (empty($arTasks) ? "bizproc-item-row-last" : "") ?>">
                                ...
                                <td class="bizproc-field-value">
                                    <input type="hidden" name="bizproc_id_<?= $bizProcIndex ?>"
                                           value="<?= $arDocumentState["ID"] ?>">
                                    <input type="hidden" name="bizproc_template_id_<?= $bizProcIndex ?>"
                                           value="<?= $arDocumentState["TEMPLATE_ID"] ?>">
                            ...
                            <tr class="<?= ($iCountRow == 1 ? "bizproc-item-row-first" : "") ?> bizproc-item-row-last">
                                ...
                                <td class="bizproc-field-value">
                                    ...
                                    foreach ($arTasks as $arTask) {
                                        ...
                                        ?><a href="<?= $url ?>"
                                             title="<?= $arTask["DESCRIPTION"] ?>"><?= $arTask["NAME"] ?></a><br/><?
                                    }
                                    ?>
                                </td>
                            </tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    if (!empty($arParams["back_url"])):
                                        ...
                                        <input type="submit" name="cancel"
                                               value="<?= GetMessage("IBEL_BIZPROC_CANCEL") ?>"/>
                                    <?
                                    endif;
                                    ?>
                                </td>
