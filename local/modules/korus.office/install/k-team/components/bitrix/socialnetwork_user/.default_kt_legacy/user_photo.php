    ...
    <noindex>
        <div class="photo-top-controls">
            <a rel="nofollow" href="<?= $result["ALL"]["GALLERY"]["LINK"]["~NEW"] ?>"
               onclick="EditAlbum('<?= CUtil::JSEscape($result["ALL"]["GALLERY"]["LINK"]["~NEW"]) ?>'); return false;"><?= GetMessage("P_ADD_ALBUM") ?></a>
            <a rel="nofollow" href="<?= $result["ALL"]["GALLERY"]["LINK"]["UPLOAD"] ?>"
               target="_self"><?= GetMessage("P_UPLOAD") ?></a>
        </div>
    </noindex>
<? endif; ?>
