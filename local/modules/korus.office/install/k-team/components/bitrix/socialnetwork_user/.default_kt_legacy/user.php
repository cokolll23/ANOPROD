...
if ($_REQUEST['old'] == 'Y' || $_REQUEST['IFRAME'] == 'Y') {
    ...
    if ($arResult["VARIABLES"]["user_id"] == $USER->GetID()) {
        ...
        Asset::getInstance()->addJs($this->GetFolder() . "/js/user.js");
        echo '<span id="favorite_user_helper" data-user-id="' . $arResult["VARIABLES"]["user_id"] . '" data-is-favorite="' . ($arResult["favourite"] ? "true" : "false") . '"></span>';
